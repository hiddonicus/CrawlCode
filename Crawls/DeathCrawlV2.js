...
function DeathCrawl() {
	...
	*/
    alert("Write 1000 words as you mount the bus. The bus ride starts normally enough, though you and " + companion + " are the only ones on it, besides the bus driver.");
    if (death == "STUPID") {
    ...
    alert("Something’s moving. Write 3% of your word count for this crawl, " + (words *0.03) + ".");
    if (death == "STUPID") {
